...
999999999999999. IMPORTANT: Keep @AGENTS.md operational only — status updates and progress notes belong in `.ralph/IMPLEMENTATION_PLAN.md`. A bloated AGENTS.md pollutes every future loop's context.